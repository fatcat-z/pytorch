...
def export(model, args, f, export_params=True, verbose=False, training=None,
           ...
           operator_export_type=None, opset_version=None, do_constant_folding=True,
...
def export_to_pretty_string(model, args, f, export_params=True, verbose=False, training=None,
                            ...
                            opset_version=None, keep_initializers_as_inputs=None,
                            custom_opsets=None, add_node_names=True,
